//
//  CennectingLine.swift
//  testingApp
//
//  Created by Samuel Garvett on 4/8/19.
...
class LineNode: SCNNode {
    ...
    var positionA: SCNVector3
    var positionB: SCNVector3
    
    
    init(with startingPoint: SCNVector3, endPoint: SCNVector3, radius: Float = 0.01, color: UIColor = .red) {
        ...
        let vector = endPoint - startingPoint
        let height = vector.length()
        
        
        
        
        cylinder = SCNCylinder(radius: CGFloat(radius), height: CGFloat(Float(height)))
        cylinder.radialSegmentCount = 8
        cylinder.firstMaterial?.diffuse.contents = color
        super.init()
        
        geometry = cylinder
        position = (endPoint + startingPoint) / 2
...
//class LineCreation: SCNNode {
//
//    var startPoint: SCNVector3
//    var endPoint: SCNVector3
//    let cylinder: SCNCylinder
//
//    // adds visual elements to the object
//    let material: SCNMaterial
//    let materialColor = UIColor.yellow
//    let lineRadius = 0.001
//    let lineColor = UIColor.yellow
//
//    init(startPoint: SCNNode, endPoint: SCNNode) {
//        //user selects the starting and ending points of the line
//      self.startPoint = SCNNode()
//      self.endPoint =
//
//    }

//    //set function that growns a node to the edges of the node frame
//    func linegrowth(from: SCNVector3, to: SCNVector3) {
//        //grown lineObject to edges
//
//        SCNTransaction.begin()
//        //create animation that will stop at edges
//        lineObject.height = 2
